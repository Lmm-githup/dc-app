 ...
 * 查询代煎中药列表
 */
export const boilMedicineApplyList = ({currentPage,pageSize,applyStatus}) => {
  return request('POST', '/boilMedicineApply/list', {currentPage,pageSize,applyStatus});
};

/**
 * 代煎中药操作
 */
export const boilMedicineApplyEdit = (param) => {
  return request('POST', '/boilMedicineApply/edit', param);
};

/**
 * 代煎中药详情
 */
export const boilMedicineApplyDetail = ({id}) => {
  return request('POST', '/boilMedicineApply/detail', {id});
};