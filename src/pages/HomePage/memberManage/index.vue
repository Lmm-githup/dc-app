  ...
  <div style="height:100%;">
    <view-box body-padding-bottom="55px">
      ...
      >
        ...
        <div
          class="header-after"
          v-if="(isSet || isWeixi) && !isOnlyMember"
          slot="right"
          style="color:#f8bb64;font-size:16px;"
        >
          ...
          alt
          >-->
          <div v-if="!isCheck" style="color:#f8bb64;font-size:12px;" @click="handleCheck">批量操作</div>
        ...
        <popup v-model="addTaskPop" height="60%">
          ...
          <div class="pop-panel" v-if="addTaskType === 1">
            ...
            <div class="pop-panel-foot">
              ...
              <div class="right">
                <x-button type="primary" class="confirm-btn" @click.native="submitNewTask" style="background:pink;">确定</x-button>
              </div>
            </div>
          </div>
