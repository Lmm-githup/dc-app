...
/deep/ .van-search--show-action{background:#312640 !important;}
/deep/ .van-search{padding:5px 10px !important;}
/deep/ .vux-header .vux-header-title{margin:0 0.9rem;width:9rem;}
/deep/ .van-search__action{color:#fff !important}
/deep/ .van-search__content{background:#443557 !important;}
/deep/ .van-cell{color:#fff;}
