  ...
  <div>
    <group title="会员信息">
      <x-input
        ...
        required
      ></x-input>
      <selector title="<span style='color:#fff'>*</span> 会员性别" :options="genderList" v-model="formData.sex"></selector>
      <x-input
        title="* 手机号码"
        ref="mobile"
        placeholder="请输入手机号码"
        ...
        required
      ></x-input>
      <datetime v-model="formData.birthday" title="<span style='color:#fff'>*</span> 生日" :start-date="startDate" class="birthday"></datetime>
    </group>
    <group>
      <x-input
        title="* 短信验证码"
...
/deep/ .weui-btn_primary{background:#FFB94E !important;border-radius: 20px;}
.check-code {
  &[disabled] {
    color: #999999;
  }
...
/deep/ .weui-label{width:6.5em !important}
</style>