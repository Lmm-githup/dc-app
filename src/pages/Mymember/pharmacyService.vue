    ...
    <div style="height:50px;margin-bottom:10px;">
      <div class="member-button-tab">
        <button-tab v-model="pharmacyType">
          <button-tab-item @on-item-click="switchTabItem">用药提醒</button-tab-item>
          <!-- <button-tab-item @on-item-click="switchTabItem">用药关怀</button-tab-item> -->
          <button-tab-item @on-item-click="switchTabItem">关联用药</button-tab-item>
        </button-tab>
      </div>
    </div>
    <div
...
.vux-button-group > a.vux-button-tab-item-last:after{
    border-right: 0.02667rem solid #FFB94E;
    border-top: 0.02667rem solid #FFB94E;
    border-bottom: 0.02667rem solid #FFB94E;
    border-left: none;
    color: #FFB94E
}
.vux-button-group > a{color: #FFB94E}
.vux-button-group > a.vux-button-tab-item-first:after{
    border: 0.02667rem solid #FFB94E;
    color: #FFB94E;
}
.vux-button-group > a.vux-button-group-current{background:#FFB94E}
</style>