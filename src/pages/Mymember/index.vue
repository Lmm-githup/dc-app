  ...
  <div style="height:100%;">
    <view-box body-padding-top="46px" body-padding-bottom="55px">
      <x-header
        ...
        ref="myheader"
        style="width:100%;position:absolute;left:0;top:0;z-index:100;background:#312640 !important"
      >
        ...
        <div class="header-after" slot="right" style="color:#f8bb64;font-size:16px;">
          <p class="batch-task" @click="handleCheck" v-if="!isCheck"><i class="fa fa-cogs" aria-hidden="true"></i></p>
          <p class="batch-task" @click="isCheck = false" v-else style="color:#fff">取消</p>
        </div>
      </x-header>
      <!-- undone -->
      ...
      <div v-transfer-dom>
        <popup v-model="addTaskPop" height="60%">
          ...
          <p class="task-nodata" v-else style="font-size:24px;text-align:center;">
            点击上面标签
            <br>选择你要进行的操作
          </p>
        </popup>
...
/deep/ .van-checkbox__label{color:#fff}
.footer {
  position: fixed;
  bottom: 8vh;
  left: 0;
