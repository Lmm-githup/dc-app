...
/deep/ .vux-tab-selected{color:#FFB94E !important;border-bottom: 0.08rem solid #FFB94E !important}
/deep/ .vux-tab-ink-bar{background-color:#FFB94E !important}
.scores-head {
  ...
  &__box {
    ...
    background: linear-gradient(#FFB94E, #FFA41A);
    .num {
      font-size: 16px;
      font-weight: 700;
    }
