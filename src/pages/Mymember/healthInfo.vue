...
/deep/ .weui-btn_primary{background:#FFB94E;-moz-box-shadow:0px 0px 8px rgba(255, 185, 78, 1);
-webkit-box-shadow:0px 0px 8px rgba(255, 185, 78, 1);box-shadow:0px 0px 8px rgba(255,185,78,1);border-radius: 20px;}
.illness-box {
  &__head {
