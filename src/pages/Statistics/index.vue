  ...
  <div class="statis-index">
    <div ref="myheader">
      <div class="top">
        <div class="header">
          ...
          <x-header :left-options="{showBack: true,backText: ''}" class="header-title"><span style="color:#fff;">统计</span></x-header>
        </div>
    ...
    <group v-if="data1.length">
      ...
      <div class="view-title">
        ...
        <select class="selectDay" v-on:change="select1">
          <option :data-index='0'>7天</option>
          <option :data-index='1'>30天</option>
        </select>
        <div class="select" @click="crmPup(1)">
          <span>{{crmValue1}}</span>
          <span style="color:black;font-size: 0.1rem;">▼</span>
        </div>
        <!-- <selector  :options="crmList" v-model="crmId1"></selector> -->
      </div>
      <v-chart v-if="data1.length" :data="[1,2]">
        <v-line :colors="colors" series-field="type"/>
      </v-chart>
    </group>
    ...
    <group v-if="data2.length">
      ...
      <div class="view-title">
        <select class="selectDay" v-on:change="select2">
          <option :data-index='0'>7天</option>
          <option :data-index='1'>30天</option>
        </select>
    ...
    <group v-if="data3.length">
      ...
      <div class="view-title">
        <select class="selectDay" v-on:change="select3">
          <option :data-index='0'>7天</option>
          <option :data-index='1'>30天</option>
        </select>
    ...
    <group v-if="data4.length">
      ...
      <div class="view-title">
        <select class="selectDay" v-on:change="select4">
          <option :data-index='0'>7天</option>
          <option :data-index='1'>30天</option>
        </select>
...
/deep/ .vux-label{background:#ffb94e;width:3rem;line-height:1rem;border-radius:0 20px 20px 0;margin-left:-15px;padding:0 0.6rem;color:#fff;}
.selectDay{width:2.5rem;height:.8rem;}
.statis-index {
  padding-bottom: 10vh;
